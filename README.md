...
1. First, you'll need to clone this repository: `git clone https://github.com/Hearsch-Jariwala/offlineRL`
...
Here's an example of how to run this using Google [Colab](https://colab.research.google.com/drive/1NUG68glhsVPoYTyUujgSaKEKSQg6fhOj?usp=sharing).
